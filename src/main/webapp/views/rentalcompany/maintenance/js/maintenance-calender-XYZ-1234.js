...
// Auto-open modal if redirected from vehiclerecords.html
const vehicleToSchedule = getQueryParam("vehicle");
if (vehicleToSchedule) {
    openScheduleMaintenanceModal(vehicleToSchedule);
}
