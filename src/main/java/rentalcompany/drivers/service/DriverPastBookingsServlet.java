    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            for (int i = 0; i < bookings.size(); i++) {
                ...
                json.append("\"customerPhone\":\"").append(escapeJson(b.getCustomerPhoneNumber())).append("\",");
                json.append("\"customerEmail\":\"").append(escapeJson(b.getCustomerEmail())).append("\",");

                json.append("\"bookingDate\":\"").append(b.getBookedDate()).append("\",");
                ...
                json.append("\"dropoffLocation\":\"").append(escapeJson(b.getDropLocation())).append("\",");
                ...
                json.append("\"vehiclePlate\":\"").append(escapeJson(b.getNumberPlate())).append("\",");
