...
public class DriverCalViewServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            List<RentalCompanyBookings> todayBookings = DriverDAO.getOngoingBookings(driverId);
            ...
            if (driver != null) {
                ...
                driverData.put("licenseNumber", driver.getDriverLicenceNumber());
                driverData.put("assignedArea", driver.getArea());
