...
public class VehicleProviderChangePasswordServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            // ── Fetch provider & verify current password ────────────
            ...
            // ── Update password ─────────────────────────────────────
            boolean updated = VehicleProviderDAO.updatePassword(provider.getProviderId(), newPassword.trim());
